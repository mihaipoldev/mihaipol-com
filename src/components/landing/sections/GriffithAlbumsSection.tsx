...
type GriffithAlbumsSectionProps = {
  albums: LandingAlbum[];
...
export default function GriffithAlbumsSection({
  albums,
  fallbackImage,
  columns = 3,
  griffithLabelSlug,
}: GriffithAlbumsSectionProps) {
  return (
    <section id="griffith-albums" className="pt-0 md:pt-16 px-6 relative z-10">
